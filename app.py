...
def render_diario_obra_page():
    ...
    # Lógica após submissão (FORA DO FORMULÁRIO)
    if submitted:
        # [Mantenha toda a lógica de processamento que você já tem...]
